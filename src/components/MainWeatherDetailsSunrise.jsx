...
export default function MainWeatherDetailsSunrise({ language, currentPlace }) {
  return (
    ...
    >
      <div className="sunrise">
        ...
        <span className="sunrise__sunset-time">
          ...
          {language === "en"
            ? getCurrentDay(currentPlace).sunsetTime
            : convertTime12To24(getCurrentDay(currentPlace).sunsetTime)}
        </span>
      </div>
    </MainWeatherDetailsPropertyMin>
  );
